...
{
	// TODO: 在此添加控件通知处理程序代码
	CString textEdit5, textEdit6, textEdit4, textEdit7, textEdit8, textEdit9;
	CString combinedText;

	// 获取 IDC_EDIT5 的文本内容
	GetDlgItemText(IDC_EDIT5, textEdit5);

	// 获取 IDC_EDIT6 的文本内容
	GetDlgItemText(IDC_EDIT6, textEdit6);

	// 获取 IDC_EDIT4 的文本内容
	GetDlgItemText(IDC_EDIT4, textEdit4);

	// 获取 IDC_EDIT7 的文本内容
	GetDlgItemText(IDC_EDIT7, textEdit7);

	// 获取 IDC_EDIT8 的文本内容
	GetDlgItemText(IDC_EDIT8, textEdit8);

	// 获取 IDC_EDIT9 的文本内容
	GetDlgItemText(IDC_EDIT9, textEdit9);

	// 合并所有文本内容按顺序
	combinedText.Format(_T("%s\n%s\n%s\n%s\n%s\n%s"),
		textEdit5, textEdit6, textEdit4, textEdit7, textEdit8, textEdit9);

	// 设置合并后的文本到 IDC_EDIT3
	SetDlgItemText(IDC_EDIT3, combinedText);
